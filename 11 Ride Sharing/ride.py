...
class Ride:
    def __init__(self, start_location, end_location, vehicle_type) -> None:
        ...
        self.end_time = None
        self.estimated_fare = self.calculate_fare(vehicle_type.vehicle_type)
...
class RideMatching:
    ...
    def find_driver(self, ride_request, vehicle_type):
        if len(self.available_drivers) > 0:
            ...
            if vehicle_type == 'car':
                vehicle = Car('car', 'df5454', 500)
            elif vehicle_type == 'bike':
                vehicle = Bike('bike', 'af478', 200)
